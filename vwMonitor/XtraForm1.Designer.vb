...
Partial Class XtraForm1
    ...
    Private Sub InitializeComponent()
        ...
        Me.verScrap = New System.Windows.Forms.Timer(Me.components)
        Me.kanban_fecha = New System.Windows.Forms.Timer(Me.components)
        Me.kanban_pedidos = New System.Windows.Forms.Timer(Me.components)
        Me.kanban_sensores = New System.Windows.Forms.Timer(Me.components)
        Me.cincoBotones_2 = New System.Windows.Forms.Timer(Me.components)
        ...
        'verScrap
        '
        Me.verScrap.Interval = 10000
        '
        'kanban_fecha
        '
        Me.kanban_fecha.Interval = 2000
        '
        'kanban_pedidos
        '
        Me.kanban_pedidos.Interval = 5000
        '
        'kanban_sensores
        '
        Me.kanban_sensores.Interval = 5000
        '
        'cincoBotones_2
        '
        Me.cincoBotones_2.Interval = 1000
        '
        'XtraForm1
        '
    ...
    Friend WithEvents verScrap As Timer
    Friend WithEvents kanban_fecha As Timer
    Friend WithEvents kanban_pedidos As Timer
    Friend WithEvents kanban_sensores As Timer
    Friend WithEvents cincoBotones_2 As Timer
End Class
