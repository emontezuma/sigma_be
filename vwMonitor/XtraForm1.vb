...
Public Class    XtraForm1
    ...
    Private Sub XtraForm1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If cadenaConexionMMCALL = "" Then
                cadenaConexionMMCALL = "server=localhost;user id=root;password=usbw;port=3307;Convert Zero Datetime=True;Allow User Variables=True"
            Else
                Dim baseCadenaConexion = "server=localhost;user id=root;password=usbw;port=3307;Convert Zero Datetime=True;Allow User Variables=True"
                Dim arreParametros = baseCadenaConexion.Split(New Char() {";"c})
    ...
    Private Sub revisaFlag_Tick(sender As Object, e As EventArgs) Handles revisaFlag.Tick
        ...
        horaDesde = Now
        Dim cadSQL As String = "SELECT hibrido_alarmar_ubicacion, hibrido_alarmar_reparacion, turno_oee, mapa_solicitud, ruta_programa_mapa, be_log_lineas, be_log_activar, audios_activar FROM " & rutaBD & ".configuracion"
                            ...
                            If derecha.Substring(1, 1) = "1" Then
                                ...
                                If licValida Or anyo & mes & dia <> "99999999" Then
                                    If IsDate(anyo & "/" & mes & "/" & dia) Then
                                        ...
                                        Else
                                            LabelControl2.Text = "DEMO vence el " & Format(DateAndTime.DateValue(anyo & "/" & mes & "/" & dia), "ddd, dd/MMM/yyyy")
                                        End If
    ...
    Sub sensoresTick()
        If revisandoSensores Or modulos(5) = 0 Then Exit Sub
        If primerSensor Then primerSensor = False
        Dim hayParoNP
        Dim ultimo = DateAndTime.Now()
        revisandoSensores = True
            ...
            If capturas.Tables(0).Rows.Count > 0 Then
                ...
                For Each captura In capturas.Tables(0).Rows
                    ...
                    If equipoActual <> captura!maquinaid Or equipoActual = 0 Then
                        ...
                        DIS = Math.Round(DIS, 3)
                        FTQ = Math.Round(FTQ, 3)
                        MsgBox("Maquina " & captura!maquinaid & " FTQ " & FTQ)
...
CREATE TABLE `disponibilidad` (
  ...
  `estatus` char(1) COLLATE utf8_bin DEFAULT 'A' COMMENT 'Estatus del registro',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=219 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Tabla de disponibilidad';
...
insert  into `figuras`(`id`,`mapa_id`,`objeto_id`,`x`,`y`,`ancho`,`largo`,`rotacion`,`idx`,`idy`,`rotacion_texto`,`tipo_id`,`color_borde`,`alfa_borde`,`color_fondo`,`alfa_fondo`,`color_texto`,`fuente`,`tamano_fuente`,`fuente_italica`,`fuente_negrita`,`archivo`,`status_asociado`,`ultima_actualizacion`,`mensaje`,`efecto`,`ancho_borde`) values ('shp10',109,'1',69.7137,234.739,239.248,188.17,0,132.583,174.125,0,118,'#FFC000',1,'#FF0000',0.50196,'#000000','Calibri',18,0,0,'',0,'2019-12-13 13:39:20','','P',6),('shp51',109,'1',69.7137,234.739,239.248,188.17,0,132.583,174.125,0,118,'#FF0000',1,'#FFC000',0.50196,'#000000','Calibri',18,0,0,'',10,'2019-12-13 13:39:20','','P',6),('shp14',109,'2',498.081,27.982,245.77,65.0659,0,579.633,-4.27638,0,118,'#FFC000',1,'#FF0000',0.50196,'#000000','Calibri',18,0,0,'',0,'2019-12-13 13:39:20','','P',6),('shp18',109,'2',498.081,27.7053,245.77,65.0659,0,579.633,-4.55307,0,118,'#FF0000',1,'#FFC000',0.50196,'#000000','Calibri',18,0,0,'',10,'2019-12-13 13:39:20','','P',6),('shp21',109,'3',815.513,116.849,107.729,215.171,0,842.262,16.6822,0,118,'#FFC000',1,'#FF0000',0.50196,'#000000','Calibri',18,0,0,'',0,'2019-12-13 13:39:20','','P',6),('shp24',109,'3',815.513,116.576,107.729,215.171,0,842.262,16.409,0,118,'#FF0000',1,'#FFC000',0.50196,'#000000','Calibri',18,0,0,'',10,'2019-12-13 13:39:20','','P',6),('shp27',109,'4',289.481,61.6044,140.775,72.8194,0,324.435,27.7054,0,118,'#FFC000',1,'#FF0000',0.50196,'#000000','Calibri',18,0,0,'',0,'2019-12-13 13:39:20','','P',6),('shp30',109,'4',289.481,61.6044,140.775,72.8194,0,324.435,27.7053,0,118,'#FF0000',1,'#FFC000',0.50196,'#000000','Calibri',18,0,0,'',10,'2019-12-13 13:39:20','','P',6),('shp33',109,'5',341.453,244.414,175.306,129.466,0,384.981,184.144,0,118,'#FFC000',1,'#FF0000',0.50196,'#000000','Calibri',18,0,0,'',0,'2019-12-13 13:39
26,1,'WIP - Antic/Tiempo de stock','N',305,10,'2020-01-28 17:57:47',NULL,'A',NULL,NULL,0,0),(27,1,'WIP - Antic/Tiempo de proceso','N',306,10,'2020-01-28 18:02:04',NULL,'A',NULL,NULL,0,0),(28,1,'WIP - Antic/Tiempo de entrega','S',307,10,'2020-05-13 10:02:41',NULL,'A',NULL,NULL,0,0),(29,1,'WIP - Salto de operación','N',301,10,'2020-01-28 17:38:44',NULL,'A',NULL,NULL,0,0),(30,0,'OAE - Baja en FTQ','S',204,5,'2020-05-13 10:02:41',NULL,'A',NULL,NULL,0,0),(31,0,'OAE - Baja en Disponibilidad','S',205,5,'2020-05-13 10:02:41',NULL,'A',NULL,NULL,0,0),(32,0,'OAE - Bajo en Desempeño','S',206,5,'2020-05-13 10:02:41',NULL,'A',NULL,NULL,0,0),(33,0,'OAE - Baja en OAE','S',207,5,'2020-05-13 10:02:41',NULL,'A',NULL,NULL,0,0),(35,1,'CL - Checklist ausencia de llenado','S',401,10,NULL,NULL,'A',NULL,NULL,0,0);
...
insert  into `pu_colores`(`id`,`planta`,`usuario`,`nombre`,`personalizada`,`obligatorio`,`seleccionado`,`fondo_total`,`fondo_barra_superior`,`fondo_barra_inferior`,`fondo_aplicacion`,`fondo_seleccion`,`fondo_boton`,`fondo_slider`,`fondo_tarjeta`,`fondo_boton_inactivo`,`fondo_boton_positivo`,`fondo_boton_negativo`,`fondo_boton_barra`,`fondo_tiptool`,`fondo_logo`,`fondo_snack_normal`,`fondo_snack_error`,`borde_total`,`borde_seleccion`,`borde_hover`,`borde_boton`,`borde_boton_inactivo`,`borde_tarjeta`,`borde_tiptool`,`color_impar`,`color_par`,`texto_tarjeta`,`texto_tarjeta_resalte`,`texto_barra_superior`,`texto_barra_inferior`,`texto_boton`,`texto_boton_inactivo`,`texto_boton_positivo`,`texto_boton_negativo`,`texto_boton_barra`,`texto_seleccion`,`texto_tiptool`,`texto_snack_normal`,`texto_snack_error`,`texto_solo_texto`,`estatus`) values (1,0,1,'DARK','N','N','N','000000','404040','404040','303030','101010','353535','151515','252525','t','9ACD32','FF4500','ffffff','FFFFFF','ffffff','303030','FF6347','FFFFFF','DDDDDD','707070','BBBBBB','404040','606060','FFFFFF','t','303030','CCCCCC','FFFFFF','FFFFFF','FFFFFF','CCCCCC','404040','000000','FFFFFF','151515','FFFFFF','000000','FFFFFF','FFFFFF','909090','A'),(2,0,0,'AZUL CORPORATIVO','N','S','N','002369','f6f6f6','c9c7c7','FFFFFF','73ccf0','f0eded','cfd0d1','FFFFFF','FFFFFF','58D68D','ff0000','002369','FFFFFF','FFFFFF','d7eefc','FF6347','64718c','babdbf','73ccf0','4bc8fa','d7dadb','64718c','000000','EDFBFF','ffffff','002369','002369','002369','002369','002369','d7dadb','000000','ffffff','FFFFFF','002369','002369','002369','FFFFFF','909090','A'),(3,0,0,'AMARILLO M/L','N','N','N','2D3277','ffe600','ffe600','FFFFFF','ffe600','fff9c7','fcfbeb','fffef5','FFFFFF','ffe600','ff0000','ffffff','fff9c7','FFFFFF','fff9c7','FF0000','64718c','babdbf','73ccf0','4bc8fa','c9c17b','64718c','000000','EDFBFF','fffef5','2D3277','002369','2D3277','2D3277','2D3277','c9c17b','000000','ffffff','002369','002369','002369','002369','FFFFFF','a8a694','A');

/*Data for the table `pu_graficos` */

insert  into `pu_graficos`(`id`,`usuario`,`visualizar`,`grafico`,`titulo`,`titulo_fuente`,`sub_titulo`,`subtitulo_fuente`,`texto_x`,`texto_x_fuente`,`texto_y`,`texto_y_fuente`,`texto_z`,`texto_z_fuente`,`etiqueta_mostrar`,`etiqueta_fuente`,`etiqueta_leyenda`,`etiqueta_color`,`etiqueta_fondo`,`ancho`,`alto`,`margen_arriba`,`margen_abajo`,`margen_izquierda`,`margen_derecha`,`maximo_barras`,`maximo_barraspct`,`agrupar`,`agrupar_posicion`,`agrupar_texto`,`fecha`,`periodo_tipo`,`periodo_atras`,`mostrar_tabla`,`orden`,`color_fondo_barras`,`color_letras`,`color_fondo`,`color_leyenda_fondo`,`color_leyenda`,`ver_esperado`,`grueso_esperado`,`color_esperado`,`texto_esperado`,`valor_esperado`,`incluir_ceros`,`orden_grafica`,`mostrarpct`,`color_barra`,`color_barra_borde`,`color_barra_o`,`color_barra_borde_o`,`ver_leyenda`,`overlap`,`adicionales`,`adicionales_colores`,`adicionales_titulos`,`oee`,`oee_colores`,`oee_tipo`,`oee_nombre`,`tipo_principal`,`colores_multiples`,`color_spiline`,`grueso_spiline`,`mostrar_argumentos`,`activo`,`esperado_esquema`) values (63,0,'S',1,'ENTREGA DE LOTES POR SEMANA',25,NULL,20,'SEMANAS DEL AÑO',17,'NUMERO DE LOTES',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2019-09-13 01:12:46',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B',NULL,NULL,0,'S','N',NULL),(64,0,'S',1,'ENTREGA DE LOTES POR SEMANA',25,'Ver filtro',20,'Semanas',17,'NUMERO DE LOTES',17,'1;2;3;',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2019-09-13 01:45:44',NULL,NULL,'S',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B',NULL,NULL,0,'S','N',NULL),(66,0,'S',2,'ENTREGA DE LOTES POR OPERACIÓN',25,NULL,20,'OPERACIONES',17,'NUMERO DE LOTES',17,'1;2;3;',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2019-09-14 00:13:50',NULL,NULL,'S',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B',NULL,NULL,0,'S','N',NULL),(67,0,'S',2,'ENTREGA DE LOTES POR OPERACIÓN',25,NULL,20,NULL,17,'0',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2019-09-14 01:46:35',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B',NULL,NULL,0,'S','N',NULL),(68,0,'S',3,'PRODUCTIVIDAD POR OPERACIÓN',25,NULL,20,NULL,17,'0',17,'1;2;3;',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2019-09-14 01:46:44',NULL,NULL,'S',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B',NULL,NULL,0,'S','N',NULL),(71,0,'S',3,'PRODUCTIVIDAD POR OPERACIÓN',25,'operaciones',20,'OPERACIONES',17,'Lotes producidos',17,'1;2;3;Productividad (%)',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2019-09-14 02:35:16',NULL,NULL,'N',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B','S',NULL,0,'S','N',NULL),(72,0,'S',101,'MTTR POR CELULA',25,'EJEMPLO DEL SISTEMA',20,'CELULAS DE PRODUCCION',17,'MTTR Tiempo promedio de reparación/Horas)',17,'0',NULL,NULL,17,'0',NULL,NULL,0,0,0,0,0,0,10,0,'S','F','LINEA AGRUPADA','2019-10-20 09:44:45',NULL,NULL,NULL,NULL,'',NULL,'','','',NULL,NULL,NULL,NULL,'0.000','N','M','N',NULL,NULL,NULL,NULL,'N','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B','S','FF0000',0,'S','S',NULL),(73,0,'S',102,'MTTR POR MAQUINA',25,'EJEMPLO DEL SISTEMA',20,'MAQUINAS',17,'MTTR Tiempo promedio de reparación/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,10,0,'S','F','MAQUINA AGRUPADA','2019-10-20 16:35:25',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B','N',NULL,0,'S','S',NULL),(74,0,'S',103,'MTTR POR ÁREA',25,'EJEMPLO DEL SISTEMA',20,'AREAS',17,'MTTR Tiempo promedio de reparación/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,10,0,'S','F','ÁREA AGRUPADA','2019-10-20 16:36:29',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B','N',NULL,0,'S','S',NULL),(75,0,'S',104,'MTTR POR FALLA',25,'EJEMPLO DEL SISTEMA',20,'FALLAS',17,'MTTR Tiempo promedio de reparación/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,10,75,'S','O','FALLAS AGRUPADA','2019-10-20 16:36:30',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','M','N',NULL,NULL,NULL,NULL,'S','R','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B','S',NULL,0,'S','S',NULL),(77,0,'S',105,'MTTR POR TIPO DE MAQUINA',25,'EJEMPLO DEL SISTEMA',20,'TIPOS DE MAQUINA',17,'MTTR Tiempo promedio de reparación/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,10,0,'S','F','TIPOS DE MAQUINA','2019-10-21 19:23:52',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B','N',NULL,0,'S','S',NULL),(78,0,'S',106,'MTTR POR AGRUPADOR (1) DE MAQUINA',25,'EJEMPLO DEL SISTEMA',20,'AGRUPADORES 1',17,'MTTR Tiempo promedio de reparación/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,10,0,'S','F','AGRUPADOR 1','2019-10-22 00:43:42',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B','N',NULL,0,'S','S',NULL),(79,0,'S',107,'MTTR POR AGRUPADOR (2) DE MAQUINA',25,'EJEMPLO DEL SISTEMA',20,'AGRUPADORES 2',17,'MTTR Tiempo promedio de reparación/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,10,0,'S','F','AGRUPADOR 2','2019-10-22 00:43:43',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B','S',NULL,0,'S','S',NULL),(80,0,'S',108,'MTTR POR AGRUPADOR (1) DE FALLAS',25,'EJEMPLO DEL SISTEMA',20,'AGRUPADORES 1',17,'MTTR Tiempo promedio de reparación/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,10,0,'S','F','AGRUPADOR 1','2019-10-22 00:43:45',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B','S',NULL,0,'S','S',NULL),(81,0,'S',109,'MTTR POR AGRUPADOR (2) DE FALLAS',25,'EJEMPLO DEL SISTEMA',20,'AGRUPADORES 2',17,'MTTR Tiempo promedio de reparación/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'S','F','AGRUPADOR 2','2019-10-22 00:43:46',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B','S',NULL,0,'S','S',NULL),(82,0,'N',110,'MTTR POR DIA',25,'EJEMPLO DEL SISTEMA',20,'DIA',17,'MTTR Tiempo promedio de reparación/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'S','F','DIA','2019-10-22 01:08:56',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B','S',NULL,0,'S','S',NULL),(83,0,'N',111,'MTTR POR SEMANA',25,'EJEMPLO DEL SISTEMA',20,'SEMANA',17,'MTTR Tiempo promedio de reparación/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'S','F','SEMANA','2019-10-22 01:08:57',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B','S',NULL,0,'S','S',NULL),(84,0,'N',112,'MTTR POR MES',25,'EJEMPLO DEL SISTEMA',20,'MES',17,'MTTR Tiempo promedio de reparación/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'S','F','MES','2019-10-22 01:08:58',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B','S',NULL,0,'S','S',NULL),(85,0,'S',113,'MTTR POR TECNICO',25,'EJEMPLO DEL SISTEMA',20,'TECNICO',17,'MTTR Tiempo promedio de reparación/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'S','F','TECNICO','2019-10-22 01:08:59',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B','S',NULL,0,'S','S',NULL),(86,0,'S',201,'MTBF POR LINEA',25,NULL,20,'CELULAS DE PRODUCCION',17,'MTBF (Tiempo promedio entre fallas/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2019-10-21 21:30:09',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B',NULL,NULL,0,'S','S',NULL),(87,0,'S',202,'MTBF POR MAQUINA',25,NULL,20,'MAQUINAS',17,'MTBF (Tiempo promedio entre fallas/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2019-10-21 21:30:11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B',NULL,NULL,0,'S','S',NULL),(88,0,'S',203,'MTBF POR AREA',25,NULL,20,'AREAS',17,'MTBF (Tiempo promedio entre fallas/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2019-10-21 21:30:11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B',NULL,NULL,0,'S','S',NULL),(89,0,'S',204,'MTBF POR FALLA',25,NULL,20,'FALLAS',17,'MTBF (Tiempo promedio entre fallas/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2019-10-21 21:30:12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B',NULL,NULL,0,'S','S',NULL),(90,0,'S',205,'MTBF POR TIPO DE MAQUINA',25,NULL,20,'TIPOS DE MAQUINA',17,'MTBF (Tiempo promedio entre fallas/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2019-10-21 21:30:14',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B',NULL,NULL,0,'S','S',NULL),(91,0,'S',206,'MTBF POR AGRUPADOR (1) DE MAQUINA',25,NULL,20,'AGRUPADORES 1',17,'MTBF (Tiempo promedio entre fallas/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2019-10-21 21:30:14',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B',NULL,NULL,0,'S','S',NULL),(92,0,'S',207,'MTBF POR AGRUPADOR (2) DE MAQUINA',25,NULL,20,'AGRUPADORES 2',17,'MTBF (Tiempo promedio entre fallas/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2019-10-21 21:30:17',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B',NULL,NULL,0,'S','S',NULL),(93,0,'S',208,'MTBF POR AGRUPADOR (1) DE FALLAS',25,NULL,20,'AGRUPADORES 1',17,'MTBF (Tiempo promedio entre fallas/Horas)',17,'0',NULL,NULL,17,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,'2019-10-21 21:30:18',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N',NULL,NULL,NULL,'0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B',NULL,NULL,0,'S','S',NULL),
.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','NNNNNN',NULL,NULL,'NNN',NULL,'BBB',NULL,'B',NULL,NULL,0,'S','S',NULL),(186,0,'S',605,'Rechazos por Dïa',25,NULL,20,'DIAS DEL AÑO',NULL,'NÚMERO DE RECHAZOS',17,'PCT acumulado',10,'S',17,'Leyenda',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'N','N','AGRUPADO','2020-05-03 22:42:52',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,'N',1,NULL,'ESPERADO','0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','0;0;0;0;0;0;0',NULL,NULL,'NNN',NULL,'BBB',';;','B','S',NULL,0,'S','S',NULL),(187,0,'S',606,'Rechazos por Semana',25,NULL,20,'SEMANAS DEL AÑO',NULL,'NÚMERO DE RECHAZOS',17,'PCT acumulado',10,'S',17,'Leyenda',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'N','N','AGRUPADO','2020-05-03 22:42:54',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,'N',1,NULL,'ESPERADO','0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','0;0;0;0;0;0;0',NULL,NULL,'NNN',NULL,'BBB',';;','B','S',NULL,0,'S','S',NULL),(188,0,'S',607,'Rechazos por Mes',25,NULL,20,'MESES DEL AÑO',NULL,'NÚMERO DE RECHAZOS',17,'PCT acumulado',10,'S',17,'Leyenda',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'N','N','AGRUPADO','2020-05-03 22:42:56',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,'N',1,NULL,'ESPERADO','0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','0;0;0;0;0;0;0',NULL,NULL,'NNN',NULL,'BBB',';;','B','S',NULL,0,'S','S',NULL),(182,0,'S',601,'Rechazos por Linea',25,NULL,20,'LINEAS/CELULAS',NULL,'NÚMERO DE RECHAZOS',17,'PCT acumulado',10,'S',17,'Leyenda',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'N','N','AGRUPADO','2020-05-03 22:42:42',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,'N',1,NULL,'ESPERADO','0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','0;0;0;0;0;0;0',NULL,NULL,'NNN',NULL,'BBB',';;','B','S',NULL,0,'S','S',NULL),(183,0,'S',602,'Rechazos por Máquina',25,NULL,20,'MAQUINA',NULL,'NÚMERO DE RECHAZOS',17,'PCT acumulado',10,'S',17,'Leyenda',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'N','N','AGRUPADO','2020-05-03 22:42:44',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,'N',1,NULL,'ESPERADO','0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','0;0;0;0;0;0;0',NULL,NULL,'NNN',NULL,'BBB',';;','B','S',NULL,0,'S','S',NULL),(184,0,'S',603,'Rechazos por Área',25,NULL,20,'AREAS',NULL,'NÚMERO DE RECHAZOS',17,'PCT acumulado',10,'S',17,'Leyenda',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'N','N','AGRUPADO','2020-05-03 22:42:49',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,'N',1,NULL,'ESPERADO','0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','0;0;0;0;0;0;0',NULL,NULL,'NNN',NULL,'BBB',';;','B','S',NULL,0,'S','S',NULL),(185,0,'S',604,'Rechazos por Concepto',25,NULL,20,'CONCEPTOS DE RECHAZO',NULL,'NÚMERO DE RECHAZOS',17,'PCT acumulado',10,'S',17,'Leyenda',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'N','N','AGRUPADO','2020-05-03 22:42:50',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,'N',1,NULL,'ESPERADO','0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','0;0;0;0;0;0;0',NULL,NULL,'NNN',NULL,'BBB',';;','B','S',NULL,0,'S','S',NULL),(170,0,'S',501,'Paros por Línea',25,NULL,20,'LINEAS/CELULAS',17,'HORAS DE PARO',17,'PCT acumulado',10,'S',17,'Leyenda',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'N','N','AGRUPADO','2020-03-17 20:29:47',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,'N',1,NULL,'ESPERADO','0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','0;0;0;0;0;0;0',NULL,NULL,'NNN',NULL,'BBB',';;','B','S',NULL,0,'S','S',NULL),(172,0,'S',502,'Paros por Máquina',25,NULL,20,'MAQUINAS',17,'HORAS DE PARO',17,'PCT acumulado',10,'S',17,'Leyenda',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'N','N','AGRUPADO','2020-03-18 00:24:29',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,'N',1,NULL,'ESPERADO','0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','0;0;0;0;0;0;0',NULL,NULL,'NNN',NULL,'BBB',';;','B','S',NULL,0,'S','S',NULL),(173,0,'S',503,'Paros por Área',25,NULL,20,'AREAS',17,'HORAS DE PARO',17,'PCT acumulado',10,'S',17,'Leyenda',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'N','N','AGRUPADO','2020-03-18 00:24:46',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,'N',1,NULL,'ESPERADO','0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','0;0;0;0;0;0;0',NULL,NULL,'NNN',NULL,'BBB',';;','B','S',NULL,0,'S','S',NULL),(174,0,'S',504,'Paros por Concepto',25,NULL,20,'CONCEPTOS DE MANTENIMIENTO',17,'HORAS DE PARO',17,'PCT acumulado',10,'S',17,'Leyenda',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'N','N','AGRUPADO','2020-03-18 00:24:47',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,'N',1,NULL,'ESPERADO','0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','0;0;0;0;0;0;0',NULL,NULL,'NNN',NULL,'BBB',';;','B','S',NULL,0,'S','S',NULL),(175,0,'S',505,'Paros por Dïa',25,NULL,20,'DIAS DEL AÑO',17,'HORAS DE PARO',17,'PCT acumulado',10,'S',17,'Leyenda',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'N','N','AGRUPADO','2020-03-18 00:25:03',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,'N',1,NULL,'ESPERADO','0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','0;0;0;0;0;0;0',NULL,NULL,'NNN',NULL,'BBB',';;','B','S',NULL,0,'S','S',NULL),(176,0,'S',506,'Paros por Semana',25,NULL,20,'SEMANAS DEL AÑO',17,'HORAS DE PARO',17,'PCT acumulado',10,'S',17,'Leyenda',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'N','N','AGRUPADO','2020-03-18 00:25:10',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,'N',1,NULL,'ESPERADO','0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','0;0;0;0;0;0;0',NULL,NULL,'NNN',NULL,'BBB',';;','B','S',NULL,0,'S','S',NULL),(177,0,'S',507,'Paros por Mes',25,NULL,20,'MESES DEL AÑO',17,'HORAS DE PARO',17,'PCT acumulado',10,'S',17,'Leyenda',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,'N','N','AGRUPADO','2020-03-18 00:26:07',NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,'N',1,NULL,'ESPERADO','0.000','N','N','N',NULL,NULL,NULL,NULL,'S','S','0;0;0;0;0;0;0',NULL,NULL,'NNN',NULL,'BBB',';;','B','S',NULL,0,'S','S',NULL);
...
insert  into `tablas`(`id`,`nombre`) values (50,'TIPOS DE MÁQUINA'),(10,'LINEAS AGRUPADOR 1'),(15,'LINEAS AGRUPADOR 2'),(20,'MAQUINAS AGRUPADOR 1'),(25,'MAQUINAS AGRUPADOR 2'),(30,'AREAS AGRUPADOR 1'),(35,'AREAS AGRUPADOR 2'),(40,'FALLAS AGRUPADOR 1'),(45,'FALLAS AGRUPADOR 2'),(70,'DEPARTAMENTOS'),(80,'COMPANIAS'),(90,'PLANTAS'),(100,'PAGERS DE MMCALL'),(60,'TIPOS DE MANTENIMIENTO'),(105,'DEFECTOS DE CALIDAD'),(110,'UNIDADES DE MEDIDA'),(115,'TIPOS DE VARIABLES'),(120,'TIPOS DE CHECKLISTS');
